...
> Lineage: 0 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\data-retention-policies](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\data-retention-policies) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package data-retention-policies -Apply

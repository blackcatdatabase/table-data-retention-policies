...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 0 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\data-retention-policies](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\data-retention-policies)
...
graph LR
  ...
  data_retention_policies["data_retention_policies"]:::center
  retention_enforcement_jobs["retention_enforcement_jobs"]:::inbound -->|FK| data_retention_policies
...
- Inbound (relies on this): "retention_enforcement_jobs"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package data-retention-policies -Apply

...
final class DataRetentionPoliciesModule implements ModuleInterface
{
    public function name(): string { return 'table-data_retention_policies'; }
    public function table(): string { return 'data_retention_policies'; }
    ...
    public static function contractView(): string { return 'vw_data_retention_policies'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_drp_active', 'idx_drp_entity' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_drp_active', 'idx_drp_entity' ],
            'foreignKeys' => [],
        ];
    }
}

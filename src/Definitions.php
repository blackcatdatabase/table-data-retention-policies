...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'data_retention_policies'; }
    public static function contractView(): string { return 'vw_data_retention_policies'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'entity_table', 'field_name', 'action', 'keep_for', 'active', 'notes', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'entity_table', 'field_name', 'action', 'keep_for' ], [ 'id' ] ]; }

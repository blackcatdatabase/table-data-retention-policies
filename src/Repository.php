...
use BlackCat\Database\Packages\DataRetentionPolicies\Repository\DataRetentionPolicyRepository;
...
{
    private DataRetentionPolicyRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new DataRetentionPolicyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\DataRetentionPolicies\Dto\DataRetentionPolicyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\DataRetentionPolicies\Dto\DataRetentionPolicyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\DataRetentionPolicies\Dto\DataRetentionPolicyDto|null
    {

...
namespace BlackCat\Database\Packages\DataRetentionPolicies;
...
use BlackCat\Database\Packages\DataRetentionPolicies\Repository\DataRetentionPolicyRepository as GeneratedRepository;
...
{
  private DataRetentionPolicyRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof DataRetentionPolicyRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected DataRetentionPolicyRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\DataRetentionPolicies\Dto\DataRetentionPolicyDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\DataRetentionPolicies\Dto\DataRetentionPolicyDto|null { return $this->repo->getById($id, $asDto); }

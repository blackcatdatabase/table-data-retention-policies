...
namespace BlackCat\Database\Packages\DataRetentionPolicies\Dto;
 ...
 */
final class DataRetentionPolicyDto implements \JsonSerializable {
    public function __construct(
        public readonly int $id,
        public readonly string $entityTable,
        public readonly ?string $fieldName,
        public readonly string $action,
        public readonly string $keepFor,

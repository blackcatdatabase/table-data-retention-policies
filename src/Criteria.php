...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'entity_table', 'field_name', 'action', 'keep_for', 'active', 'notes', 'created_at' ];
    }

    /** Columns used for full-text LIKE/ILIKE searches. */
    protected function searchable(): array
    {
        return [ 'entity_table', 'field_name', 'keep_for', 'notes' ];
    }

    /** Columns allowed in ORDER BY (falls back to filterable() when empty). */
    protected function sortable(): array
    {
        $x = [ 'id', 'entity_table', 'field_name', 'action', 'keep_for', 'active', 'notes', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\DataRetentionPolicies\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\DataRetentionPolicies\Definitions::softDeleteColumn();

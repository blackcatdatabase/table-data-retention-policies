...
namespace BlackCat\Database\Packages\DataRetentionPolicies\Mapper;

use BlackCat\Database\Packages\DataRetentionPolicies\Dto\DataRetentionPolicyDto;
use BlackCat\Database\Packages\DataRetentionPolicies\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO DataRetentionPolicyDto:
...
final class DataRetentionPolicyDtoMapper
{
     ...
     */
    public static function fromRow(array $row): DataRetentionPolicyDto
    {
        /** @var DataRetentionPolicyDto */
        return DtoHydrator::fromRow(
            DataRetentionPolicyDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?DataRetentionPolicyDto
    {
     ...
     *
     * @param DataRetentionPolicyDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(DataRetentionPolicyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(DataRetentionPolicyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(DataRetentionPolicyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,DataRetentionPolicyDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,DataRetentionPolicyDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(DataRetentionPolicyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,DataRetentionPolicyDto>
     */
